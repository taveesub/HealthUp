...
INSERT INTO sport(code, name, description,location ,group0,group1,group2,group3,group4,group5,guide)
...
If you’re a beginner, run for 20 to 30 minutes twice a week. Your pace should be conversational during the run. You can alternate between 5 minutes of running and 1 minute of walking to start. To stay injury-free, always stretch after your run.','../static/images/running.png','F','T','T','F','F','F',2),
...
','../static/images/aerobics.png','T','T','T','F','T','T',2),
...
If you get tired, rest on the side of the pool between laps. Always follow the safety instructions and guidelines of the pool where you swim.','../static/images/swimming.png','T','T','T','F','T','T',2),
        ('S004','riding a bike fast or on hills','','../static/images/ride a bike.png','F','T','F','F','F','F',2),
...
Duration and frequency: 15 to 25 minutes, 1 time per week','../static/images/tennis.png','T','T','T','F','T','F',2),
        ('S006','football','','../static/images/football.png','F','T','F','F','F','F',2),
        ('S007','hiking uphill','','../static/images/hiking.png','F','T','F','F','F','F',2),
        ('S008','energetic dancing','','../static/images/dancing.png','F','T','F','F','F','F',2),
...
Duration and frequency: 15 to 25 minutes, 1 time per week','../static/images/martial arts.png','F','T','T','F','T','F',2),
...
Duration and frequency: 15 to 25 minutes, 2-3 times per week','../static/images/table-tennis.png','T','T','T','F','T','T',2),
        ('S011','brisk walking','','../static/images/brisk walking.png','T','T','T','F','T','T',0),
        ('S012','water aerobics','','../static/images/water aerobics.png','T','T','T','T','T','T',0),
        ('S013','riding a bike','','../static/images/ride a bike.png','T','T','T','F','T','F',0),
        ('S014','dancing','','../static/images/dancing.png','F','T','T','F','T','T',0),
        ('S015','doubles tennis','','../static/images/tennis.png','T','T','T','F','T','F',0),
        ('S016','pushing a lawn mower','','../static/images/pushing a lawn mower.png','T','T','T','F','T','T',0),
        ('S017','hiking','','../static/images/hiking.png','F','T','F','F','F','F',0),
        ('S018','yoga','','../static/images/yoga.png','T','T','T','T','T','T',0),
...
','../static/images/green-tea.png','T','T','T','T','T','T',1),
...
','../static/images/moving around home.png','T','T','T','T','T','T',1),
...
4. Boosts productivity','../static/images/standing up.png','T','T','T','T','T','T',1);
